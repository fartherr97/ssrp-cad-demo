...
import {
  ...
  LIMITS_CONFIG, CALL_NATURES_DEFAULT, CITIZEN_REPORT_TYPES_DEFAULT, DISCORD_ROLE_MAPPINGS_DEFAULT, ADMIN_TIERS_DEFAULT,
} from '../data/adminData';
...
const initialState = {
  ...
  citizenReportTypes: CITIZEN_REPORT_TYPES_DEFAULT,
  tenCodes: TEN_CODES,
