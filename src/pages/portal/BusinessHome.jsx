...
const EMPLOYEE_ACTIONS = [
  { to: '/portal/employee-profile', icon: MdPerson,   title: 'My Profile',  desc: 'View your role and business info' },
  { to: '/portal/employees',        icon: MdGroup,    title: 'Our Team',    desc: 'See who you work with' },
  { to: '/portal/laws',             icon: MdMenuBook, title: 'State Laws',  desc: 'Browse the penal code reference' },
];
  ...
  return (
    <PortalPage>
      ...
      <div className="grid gap-3.5 mb-[30px]" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 240px), 1fr))' }}>
        {(isOwner ? OWNER_ACTIONS : EMPLOYEE_ACTIONS).map(a => (
