      ...
      {results && (
        <div>
          {!results.civResult && !results.vehResult && (
            <div style={{ color: '#ef4444', background: '#1a0505', border: '1px solid #ef4444', borderRadius: '4px', padding: '12px', fontSize: '13px' }}>
          ...
          {results.civResult && results.civWarrants.length > 0 && (
            <Section title="ACTIVE WARRANTS">
              {results.civWarrants.map(w => (
                <div key={w.id} style={{ background: '#1a0505', border: '1px solid #ef4444', borderRadius: '4px', padding: '12px', marginBottom: '8px', fontSize: '12px' }}>
                  ...
                  {w.notes && <div style={{ color: '#64748b', marginTop: '4px', fontSize: '11px' }}>{w.notes}</div>}
                </div>
              ))}
            </Section>
          )}
          ...
          {results.civResult && results.civWarrants.length === 0 && results.civHistory.length === 0 && (
            <div style={{ color: '#22c55e', background: '#051a05', border: '1px solid #22c55e', borderRadius: '4px', padding: '12px', fontSize: '13px' }}>
