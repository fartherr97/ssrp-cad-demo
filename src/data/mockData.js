...
export const OFFICERS = [
  ...
  { id: 6, name: "Lisa Park", badge: "MED-3", unitId: "MED-3", dept: 3, deptShort: "HCFR", subdivision: "Rescue", rank: "Paramedic", status: "ENRT", callId: "23-1044", location: "County Hospital", discordId: "722516079", role: "user" },
  { id: 7, name: "Frank Donovan", badge: "FD-11", unitId: "E-11", dept: 3, deptShort: "HCFR", subdivision: "Engine", rank: "Firefighter", status: "AVAILABLE", callId: null, location: "Station 4", discordId: "823627180", role: "user" },
  ...
  { id: 10, name: "Marcus Hale", badge: "FD-22", unitId: "L-7", dept: 3, deptShort: "HCFR", subdivision: "Ladder", rank: "Driver Engineer", status: "ENRT", callId: "23-1044", location: "88 Commerce Blvd", discordId: "100200301", role: "user" },
  { id: 11, name: "Elena Ruiz", badge: "FD-31", unitId: "MED-7", dept: 3, deptShort: "HCFR", subdivision: "Rescue", rank: "Paramedic", status: "AVAILABLE", callId: null, location: "Station 7", discordId: "100200302", role: "user" },
  { id: 12, name: "Owen Pratt", badge: "FD-40", unitId: "BC-1", dept: 3, deptShort: "HCFR", subdivision: "Command", rank: "Battalion Chief", status: "AVAILABLE", callId: null, location: "Station 1", discordId: "100200303", role: "user" },
  { id: 13, name: "Sara Lindqvist", badge: "FD-44", unitId: "HZ-2", dept: 3, deptShort: "HCFR", subdivision: "Hazmat", rank: "Firefighter", status: "OFFDUTY", callId: null, location: "Station 2", discordId: "100200304", role: "user" },
];

export const CALLS = [
  { id: "23-1042", nature: "Traffic Stop", category: "police", location: "Elm St / Route 9", city: "Arcadia", county: "Arcadia County", priority: 3, status: "ACTIVE", units: ["831-12"], description: "Speeding vehicle, driver appears intoxicated", timestamp: "2023-10-15 14:22", reportingParty: "Officer Santos" },
  { id: "23-1043", nature: "Domestic Disturbance", category: "police", location: "412 Oakwood Ave", city: "Arcadia", county: "Arcadia County", priority: 1, status: "PENDING", units: [], description: "Caller reports loud arguing and sounds of breaking objects. Child in residence.", timestamp: "2023-10-15 14:30", reportingParty: "Dispatch" },
  { id: "23-1044", nature: "Structure Fire", category: "fire", location: "88 Commerce Blvd", city: "Greenview", county: "Arcadia County", priority: 1, status: "ACTIVE", units: ["E-11","L-7","MED-3"], description: "2-story commercial building, smoke visible from 3rd floor, occupants evacuating", timestamp: "2023-10-15 14:35", reportingParty: "911 Caller" },
  { id: "23-1045", nature: "Suspicious Person", category: "police", location: "Central Park, near fountain", city: "Arcadia", county: "Arcadia County", priority: 2, status: "PENDING", units: [], description: "Male in black hoodie staring at vehicles, possibly casing vehicles", timestamp: "2023-10-15 14:40", reportingParty: "Civilian Report" },
  { id: "23-1046", nature: "MVA w/ Injuries", category: "fire", location: "I-90 MM 42", city: "Unincorporated", county: "Arcadia County", priority: 1, status: "ENRT", units: ["SHP-09","MED-3"], description: "3-vehicle accident, 2 confirmed injuries, 1 entrapment reported", timestamp: "2023-10-15 14:45", reportingParty: "911 Caller" },
  { id: "23-1047", nature: "Noise Complaint", category: "police", location: "77 Pine Ridge Dr", city: "Arcadia", county: "Arcadia County", priority: 3, status: "PENDING", units: [], description: "Loud music, multiple neighbors calling", timestamp: "2023-10-15 14:50", reportingParty: "Dispatch" },
  { id: "23-1048", nature: "Medical - Cardiac Arrest", category: "fire", location: "210 Bayshore Blvd, Apt 4B", city: "Tampa", county: "Hillsborough County", priority: 1, status: "PENDING", units: [], description: "62 y/o male, unresponsive, bystander CPR in progress. ALS requested.", timestamp: "2023-10-15 14:52", reportingParty: "911 Caller" },
  { id: "23-1049", nature: "Brush Fire", category: "fire", location: "Riverview Nature Preserve", city: "Riverview", county: "Hillsborough County", priority: 2, status: "PENDING", units: [], description: "Approx 2 acres, wind pushing toward tree line near homes. Brush truck requested.", timestamp: "2023-10-15 14:55", reportingParty: "Park Ranger" },
];
